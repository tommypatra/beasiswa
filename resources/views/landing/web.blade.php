...
<html class="no-js" lang="">
    <head>
        ...
        @include('landing.partials.headSrc')  
        @yield('head')
    ...
    <body>
                    ...
                    <div class="col-xl-7 col-lg-6">
                        <div class="hero-img">
                            <div class="d-inline-block hero-img-right">
                                <img src="space-free-lite/assets/img/hero/hero-img.png" alt="" class="image wow fadeInRight" data-wow-delay=".5s">
                                <img src="space-free-lite/assets/img/hero/dots.shape.svg" alt="" class="dot-shape">
                                <div class="video-btn">
                ...
                <div class="client-logo-wrapper">
                    <div class="client-logo-carousel d-flex align-items-center justify-content-between">
                        <div class="client-logo">
                            <img src="space-free-lite/assets/img/client-logo/uideck-logo.svg" alt="">
                        </div>
                        <div class="client-logo">
                            <img src="space-free-lite/assets/img/client-logo/pagebulb-logo.svg" alt="">
                        </div>
                        <div class="client-logo">
                            <img src="space-free-lite/assets/img/client-logo/lineicons-logo.svg" alt="">
                        </div>
                        <div class="client-logo">
                            <img src="space-free-lite/assets/img/client-logo/graygrids-logo.svg" alt="">
                        </div>
                        <div class="client-logo">
                            <img src="space-free-lite/assets/img/client-logo/lineicons-logo.svg" alt="">
                        </div>
                        ...
                        <div class="col-xl-6 col-lg-6">
                            <div class="about-img-wrapper">
                                <div class="about-img position-relative d-inline-block wow fadeInLeft" data-wow-delay=".3s">
                                    <img src="space-free-lite/assets/img/about/about-img.png" alt="">
        ...
        <section id="contact" class="contact-section cta-bg img-bg pt-110 pb-100" style="background-image: url('space-free-lite/assets/img/bg/cta-bg.jpg');">
            <div class="container">
                <div class="row align-items-center">
        ...
        <section class="subscribe-section pt-70 pb-70 img-bg" style="background-image: url('space-free-lite/assets/img/bg/common-bg.svg')">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-xl-6 col-lg-6">
        ...
        @include('landing.partials.footerSrc')  
        @yield('scriptJs')
		<!-- ========================= JS here ========================= -->
    </body>
</html>